...
public class WeatherController extends AppCompatActivity {
    ...
    // Constants:
    final int REQUEST_CODE = 33;
    final String LOGCAT_TAG = "Clima";
    final String WEATHER_URL = "http://api.openweathermap.org/data/2.5/weather";
    // App ID to use OpenWeather data
    final String APP_ID = "d1636ffa4283131061a69c51053a263e";
    // Time between location updates (5000 milliseconds or 5 seconds)
    final long MIN_TIME = 1;
    ...
    LocationManager mLocationManager; //Start or stop requesting updates
    LocationListener mLocationListener; //Will be notified if location is changed
    ...
    private void getWeatherForCurrentLocation() {
        mLocationManager = (LocationManager) getSystemService(Context.LOCATION_SERVICE); //Gets hold of LocMan, and Assigns LM to Variable
